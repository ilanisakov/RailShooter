...
void AppClass::InitVariables(void)
{
	...
	//vector3 playerP = c_player->GetPosition();
	//vector3 diff = playerP - camP;
	//printf("Diff x[%f] y[%f] z[%f]\n\n", diff[0], diff[1], diff[2]);
	//m_pCameraMngr->MoveForward(-diff[2], railCamIndex);
	//m_pCameraMngr->MoveSideways(diff[0], railCamIndex);
	//m_pCameraMngr->MoveVertical(diff[1], railCamIndex);
	//m_pCameraMngr->SetPosition(playerP, railCamIndex);
